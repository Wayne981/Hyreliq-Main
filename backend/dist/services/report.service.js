...
const generateReportService = async (userId, fromDate, toDate) => {
    ...
    const byCategory = categories.reduce((acc, { _id, total }) => {
        acc[_id] = {
            amount: (0, format_currency_1.convertToRupeeUnit)(total),
    ...
    return {
        period: periodLabel,
        summary: {
            income: (0, format_currency_1.convertToRupeeUnit)(totalIncome),
            expenses: (0, format_currency_1.convertToRupeeUnit)(totalExpenses),
            balance: (0, format_currency_1.convertToRupeeUnit)(availableBalance),
