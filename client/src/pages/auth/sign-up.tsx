...
import dashboardImgDark from "../../assets/images/dashboad_dark.png";
      ...
      <div className="relative hidden bg-muted lg:block -mt-3">
        <div className="absolute inset-0 flex flex-col items-end justify-end pt-8 pl-8">
          <div className="w-full max-w-3xl mx-0 pr-5">
            ...
            Introducing Hyreliq — Your AI Wealth Companion
            </h1>
            <p className="mt-4 text-gray-600 dark:text-muted-foreground">
            Stay ahead with AI-driven insights, elegant monthly reports, seamless CSV imports, and effortless management of recurring transactions. Hyreliq brings clarity and confidence to your financial journey.
            </p>
          </div>
